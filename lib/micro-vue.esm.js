...
function patch(vNode1, vNode2, container, parent = null) {
    switch (vNode2.type) {
        ...
        default:
            if (vNode2.shapeFlags & 1 /* ShapeFlags.ELEMENT */)
                ...
                processComponent(vNode1, vNode2, container, parent);
    }
}
...
function processElement(vNode1, vNode2, container, parent) {
    if (vNode1)
        return updateElement(vNode1, vNode2);
...
function updateChildren(elem, vNode1, vNode2) {
    if (vNode1.shapeFlags & 4 /* ShapeFlags.TEXT_CHILDREN */ &&
        vNode2.shapeFlags & 4 /* ShapeFlags.TEXT_CHILDREN */) {
        elem.textContent = vNode2.children;
    }
    else if (vNode1.shapeFlags & 8 /* ShapeFlags.ARRAY_CHILDREN */ &&
        vNode2.shapeFlags & 4 /* ShapeFlags.TEXT_CHILDREN */) {
        [...elem].forEach((d) => d.remove());
        elem.textContent = vNode2.children;
    }
    else if (vNode1.shapeFlags & 4 /* ShapeFlags.TEXT_CHILDREN */ &&
        vNode2.shapeFlags & 8 /* ShapeFlags.ARRAY_CHILDREN */) {
        elem.textContent = '';
...
export { computed, createApp, createTextVNode, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, provide, proxyRefs, reactive, readonly, ref, renderSlots, shadowReadonly, stop, unRef };
