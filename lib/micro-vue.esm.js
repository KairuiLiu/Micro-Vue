...
export function createRenderer({ createElement, createText, remove, insert, setText, setElementText, patchProps, }) {
...
const createElement = (v) => document.createElement(v);
const createText = (v) => document.createTextNode(v);
...
export { computed, createApp, createElement, createText, createTextVNode, effect, getCurrentInstance, h, inject, insert, isProxy, isReactive, isReadonly, isRef, nextTick, patchProps, provide, proxyRefs, reactive, readonly, ref, remove, renderSlots, setElementText, setText, shadowReadonly, stop, unRef };
