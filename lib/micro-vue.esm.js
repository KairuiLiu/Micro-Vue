...
function patchKeyedChildren(c1, c2, container, parent, anchor) {
    ...
    // 中间
        ...
        oldRange.forEach((vnode) => key2indexNew.has(vnode.props.key) || vnode.el.remove());
        const idxSequence = oldRange.map((vnode) => key2indexNew.has(vnode.props.key) ? key2indexNew.get(vnode.props.key) : -1);
